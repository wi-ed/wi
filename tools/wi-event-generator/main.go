...
var tmpl = template.Must(template.New("render").Parse(`// generated by {{.CmdLine}}; DO NOT EDIT
...
//func extractEvents(inputFile, inputType string, bitmask uint) []Event {
func extractEvents(bitmask uint) []Event {
...
func generate(impl bool) ([]byte, error) {
	...
	d := tmplData{
		...
		//Events:  extractEvents(inputFile, inputType, bitmask),
		Events: extractEvents(bitmask),
	}
	out := bytes.Buffer{}
